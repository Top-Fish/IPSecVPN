...
struct state_v2_microcode v2_state_microcode_table[] = {
    ...
    { .svm_name   = "initiator-V2_init",
      ...
      .next_state = STATE_PARENT_I2,/*此状态和state2中的对应有出入*/
...
process_v2_packet(struct msg_digest **mdp)
{
    ...
    if(IKEv2_MSG_FROM_INITIATOR(md->hdr.isa_flags)) {/*响应方*/
    ...
    ret = (svm->processor)(md);/*调用状态机中的处理函数完成相应的操作*/
