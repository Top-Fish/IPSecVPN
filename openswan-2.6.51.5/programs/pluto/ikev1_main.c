...
/*md->quirks.nat_traversal_vid在解析vid载荷时进行填充*/
...
/*如果预定义了PLUUO VID 或openpgp 对端, 增加VID 数量*/
	...
	lset_t policy = preparse_isakmp_sa_body(&pre_sa_pbs);/*从报文中获取采取的认证方式: 预共享秘钥 ? 数字证书*/
	/*
...
/*应答报文封装完毕，填充长度字段*/
    ...
    /* save initiator SA for HASH *//*记录发起者的SA*/
